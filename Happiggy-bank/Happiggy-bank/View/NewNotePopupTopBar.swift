...
class NewNotePopupTopBar: UIStackView {
    ...
    /// 취소 버튼
    lazy var cancelButton: UIButton = DefaultButton(buttonTitle: StringLiteral.cancelButtonTitle)
    ...
    /// 저장 버튼
    lazy var saveButton: UIButton = DefaultButton(buttonTitle: StringLiteral.saveButtonTitle)
